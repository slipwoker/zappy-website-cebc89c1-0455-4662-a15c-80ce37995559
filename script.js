document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validateField = (input) => {
            ...
            if (input.hasAttribute('required') && !value) {
                const label = input.closest('.form-group')?.querySelector('label')?.textContent || name || 'This field';
            ...
            if (input.hasAttribute('pattern') && value) {
                ...
                if (!pattern.test(value)) {
                    showError(input, input.getAttribute('data-error-message') || 'Invalid format');
                    return false;
                }
            }
    ...
    if (animatedElements.length > 0) {
            ...
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    if (entry.target.hasAttribute('data-animation-delay')) {
                        const delay = parseInt(entry.target.getAttribute('data-animation-delay'));
                        entry.target.style.animationDelay = delay + 'ms';
                    }
                    
                    if (!entry.target.hasAttribute('data-animation-once') || entry.target.getAttribute('data-animation-once') !== 'false') {
                        observer.unobserve(entry.target);
                    }
                } else if (entry.target.hasAttribute('data-animation-once') && entry.target.getAttribute('data-animation-once') === 'false') {
        ...
        style.textContent = `
            ...
            .fade-in-left.visible { animation: fadeInLeft 0.6s ease forwards; }
            .fade-in-right.visible { animation: fadeInRight 0.6s ease forwards; }
            .fade-in-scale.visible { animation: fadeInScale 0.6s ease forwards; }
            ...
            [dir="rtl"] .fade-in-left.visible { animation: fadeInRight 0.6s ease forwards; }
            [dir="rtl"] .fade-in-right.visible { animation: fadeInLeft 0.6s ease forwards; }
        `;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'cebc89c1-0455-4662-a15c-80ce37995559',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'cebc89c1-0455-4662-a15c-80ce37995559';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cebc89c1-0455-4662-a15c-80ce37995559';
